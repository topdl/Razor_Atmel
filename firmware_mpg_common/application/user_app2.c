...
extern volatile u16 UserApp_u86timescounter;                      /*6times counter*/
extern volatile u16 UserApp_u16namedetected;
extern volatile u16 u16tempcounter;
/***********************************************************************************************************************
...
{ 
  static u8 u8namemessage[]="donglu";
  static u16 u16time=0;
if(u16tempcounter)
{
      if(UserApp_u16namedetected)
     {
      ...
      { 
         ...
         DebugLineFeed();
         DebugPrintNumber(UserApp_u16namedetected);
         DebugLineFeed();
         u16time=5000;
      }
    }
